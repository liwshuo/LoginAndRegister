 ...
 */
package com.liwshuo.data.cache;

import android.content.Context;

import com.liwshuo.data.cache.serializer.JsonSerializer;
import com.liwshuo.data.entity.UserEntity;
import com.liwshuo.data.exception.UserNotFoundException;
...
public class UserCacheImpl implements UserCache {
  ...
  @Override
  public Observable<UserEntity> get(final String userId) {
  ...
  public void put(UserEntity userEntity) {
    if (userEntity != null) {
      File userEntitiyFile = this.buildFile(userEntity.getObjectId());
      if (!isCached(userEntity.getObjectId())) {
